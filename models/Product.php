...
class Product {
    ...
    private $db;
    // Constructor
    public function __construct($name = null, $price = null, $stock = null, $description = null, $image_url = null, $category_id = null) {
    ...
    public function create($data) {
        $query = "INSERT INTO products (name, price, stock, description, image_url, created_at, updated_at, category_id)
                    VALUES (:name, :price, :stock, :description, :image_url, NOW(), NOW(), :category_id)";
