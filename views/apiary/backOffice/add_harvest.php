...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['add_harvest'])) {
    ...
    $harvest = new Harvest(null, $date, $location, $quantity, $quality, $_GET['id']);

    // Add the Apiary to the database
    $harvestC->ajouterHarvest($harvest);
                                            ...
                                            <div class="col-12 grid-margin stretch-card">
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <form action="add_harvest.php?id=<?php echo $_GET['id']; ?>" method="POST" onsubmit="return validateForm()">
                                                            ...
                                                            <button type="submit" name="add_harvest" class="btn btn-primary">Add Harvest</button>
                                                        </form>
                                                    </div>
                                                </div>
                                            </div>
