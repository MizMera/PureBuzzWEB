...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $apiaryC->modifierApiary($apiary, $idApiary);
...
if (isset($_GET['id'])) {
    $idApiary = $_GET['id'];
    $apiary = $apiaryC->recupererApiary($idApiary);
}
?>
                                    ...
                                    <div class="tab-pane fade show active" id="overview" role="tabpanel" aria-labelledby="overview">
                                        <div class="row">
                                            <div class="col-12 grid-margin stretch-card">
                                                <div class="card">
                                                    <div class="card-body">
                                                        <h4 class="card-title">Modify Apiary</h4>
                                                        <form action="modify_apiary.php?id=<?php echo $apiary['idApiary']; ?>" method="POST" onsubmit="return validateForm()">
                                                            <input type="hidden" name="idApiary" value="<?php echo htmlspecialchars($apiary['idApiary']); ?>">

                                                            <div class="form-group">
                                                                <label for="apiaryName">Apiary Name</label>
                                                                <input type="text" class="form-control" id="apiaryName" name="apiaryName" value="<?php echo htmlspecialchars($apiary['apiaryName']); ?>" placeholder="Enter Apiary Name">
                                                                <small class="text-danger" id="apiaryNameError"></small>
                                                            </div>

                                                            <div class="form-group">
                                                                <label for="beekeeper">Beekeeper</label>
                                                                <input type="text" class="form-control" name="beekeeper" id="beekeeper" value="<?php echo htmlspecialchars($apiary['beekeeper']); ?>" placeholder="Enter Beekeeper Name">
                                                                <small class="text-danger" id="beekeeperError"></small>
                                                            </div>

                                                            <div class="form-group">
                                                                <label for="location">Location</label>
                                                                <input type="text" class="form-control" name="location" id="location" value="<?php echo htmlspecialchars($apiary['location']); ?>" placeholder="Enter Location">
                                                                <small class="text-danger" id="locationError"></small>
                                                            </div>

                                                            <div class="form-group">
                                                                <label for="coordinates">Coordinates</label>
                                                                <input type="text" class="form-control" name="coordinates" id="coordinates" value="<?php echo htmlspecialchars($apiary['coordinates']); ?>" placeholder="Enter Coordinates">
                                                                <small class="text-danger" id="coordinatesError"></small>
                                                            </div>

                                                            <div class="form-group">
                                                                <label for="date">Establishment Date</label>
                                                                <input type="date" class="form-control" name="date" id="date" value="<?php echo htmlspecialchars($apiary['date']); ?>">
                                                                <small class="text-danger" id="dateError"></small>
                                                            </div>

                                                            <div class="form-group">
                                                                <label for="weather">Weather Condition</label>
                                                                <input type="text" class="form-control" name="weather" id="weather" value="<?php echo htmlspecialchars($apiary['weather']); ?>" placeholder="Enter Weather Condition">
                                                                <small class="text-danger" id="weatherError"></small>
                                                            </div>

                                                            <div class="form-group">
                                                                <label for="hiveCount">Hive Count</label>
                                                                <input type="number" class="form-control" name="hiveCount" id="hiveCount" value="<?php echo htmlspecialchars($apiary['hiveCount']); ?>" placeholder="Enter Number of Hives">
                                                                <small class="text-danger" id="hiveCountError"></small>
                                                            </div>

                                                            <div class="form-group">
                                                                <label for="observation">Observation</label>
                                                                <textarea class="form-control" name="observation" id="observation" placeholder="Enter Observations" rows="4"><?php echo htmlspecialchars($apiary['observation']); ?></textarea>
                                                                <small class="text-danger" id="observationError"></small>
                                                            </div>

                                                            <button type="submit" name="update_apiary" class="btn btn-primary">Update Apiary</button>
                                                        </form>
                                                    </div>
                                                </div>
                                            </div>
